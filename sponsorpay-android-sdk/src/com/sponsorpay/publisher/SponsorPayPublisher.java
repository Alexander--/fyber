...
public class SponsorPayPublisher {
	 ...
	 * 
	 * @param messages
         *            An EnumMap mapping {@link UIStringIdentifier}s to the
	 ...
	 * @param shouldStayOpen
         *            True if the Offer Wall should stay open after the user clicks
	 ...
	 *            Calling activity.
	 * @param listener
         *            {@link SPInterstitialRequestListener} which will be notified
